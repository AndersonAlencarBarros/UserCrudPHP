      ...
      ?>
            ...
            <div class="right_col d-flex justify-content-center" role="main">
                <div class="x_panel col-md-6" style="max-height: 400px;">
                    ...
                    <div class="x_content">
                        <form class="form-label-left input_mask" action="form.php" method="POST" novalidate>

                            <div class="col-md-12 col-sm-12 form-group has-feedback">
                                <input type="text" class="form-control has-feedback-left" required="required" id="name"
